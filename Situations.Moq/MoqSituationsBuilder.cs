...
{
    public class MoqSituationsBuilder<SituationEnum> : SituationsBuilder<SituationEnum>
        where SituationEnum : Enum
    {
        public MoqRegisteredSituation<TService> RegisterSituation<TService>(SituationEnum situation)
